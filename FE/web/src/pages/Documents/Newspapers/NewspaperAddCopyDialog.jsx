...
export default function NewspaperAddCopyDialog({ open, onClose, onSubmit }) {
    ...
    >
      <DialogTitle sx={{ pb: 1 }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Box>
            <Typography variant="h6">Thêm bản sao báo</Typography>
            <Typography variant="body2" color="text.secondary">
              Nhập mã vạch (nếu có), trạng thái, tình trạng (%) và ngày nhập kho.
            </Typography>
          </Box>
